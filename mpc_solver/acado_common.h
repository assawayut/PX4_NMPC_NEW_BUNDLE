...
/** Matrix of size: 2 x 189 (row major format) */
real_t rk_diffsTemp2[ 378 ];
...
/** Matrix of size: 495 x 3 (row major format) */
real_t E[ 1485 ];
 ...
 */
real_t acado_getKKT( void );

/** Calculate the objective value.
 *
 *  \return Value of the objective function.
 */
real_t acado_getObjective( void );
